...
$_lang["forum"] = "Форум";
$_lang["cannot.create.account.when.logged"] = "Вие не можете да направите нов профил докато сте влезли.";
...
$_lang["settings.saved.with.mail"] = "Профила беше запазен. Проверете вашата Е-Поща и активирайте акаунта отново.";
...
$_lang["settings.saved"] = "Профила беше запазен.";
...
$_lang["error.cannot.fetch.steam.api"] = "Не може да се извлече информация за вашия steam профил от steam. Опитайте по-късно.";
